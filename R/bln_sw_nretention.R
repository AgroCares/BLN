...
#'
#' @export
bln_wat_nretention_sw <- function(ID,B_LU_BRP,B_SOILTYPE_AGR,B_AER_CBS,B_GWL_CLASS,A_SOM_LOI,A_N_RT,A_CN_FR = NA_real_){

  # add visual bindigns
  bln_crops = code = choices = value_min = value_max = D_BDS = D_RD = D_OC = D_GA = FIELD_ID = D_NLV = D_NSW = NULL
