...
#'
#' This function adds default management input variables given soil type and land use. Function is a copy of the OBIC function.
#'
...
#'
#' @export
bln_add_management <- function(ID,B_LU_BRP, B_SOILTYPE_AGR,
