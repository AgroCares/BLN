...
matter content a function of summer groundwater level \@ref(fig:rothcPeat).
...
ggplot(data = dt.peat,
  ...
  ylab("Predicted soil organic matter content, (%)") +
...
For more details on these scenarios, see @Ros2024.
...
# Carbon saturation
The carbon saturation indicator `i_clim_csat` is based on @Ros2024. This indicator
...
ggplot(data = dt,
  ...
  geom_point() +
  xlab("clay content, (%)") +
  ylab("maximum soil organic matter content, (%)") +
  scale_color_viridis_d() +
...
developed specially to CO~2~ emissions of peat soils with
