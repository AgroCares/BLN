...
focussed rotation with intense residue management. 

* All arable cultivations are replaced by winter wheat

* All grassland is turned into permanent grassland. 

* Green manure is sown in August

* All crop residues are incorporated in the soil.

* Nothing changes with regards to the organic amendments compared to BAU.

The changes to the cultivations strongly increases the organic matter input from
crops. The inputs from green manures and crop residues are also increased compared
to BAU.
