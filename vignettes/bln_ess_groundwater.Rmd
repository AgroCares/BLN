...
```{r groundwater_recharge_sensitivity_figures, fig.width=8, fig.height=10, cache=FALSE}
...
```{r nitrogen_retention_demo_soiltype, fig.width=7, fig.height=3, cache=FALSE}
