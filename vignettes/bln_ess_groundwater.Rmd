...
## Introduction
Groundwater is used as source of drinking water, irrigation, and to supply natural habitats
...
With these inputs, the function calculates soil permeability and the risks of
sealing and soil compaction, both of which hamper groundwater recharge.
...
compaction risk. Instead, this function considers whether the soil is 
